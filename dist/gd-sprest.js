        ...
        execute: function execute() {
            ...
            gd_sprest = {
                ...
                List: function List(listName, targetInfo) {
                    return new index_2.List(listName, targetInfo);
                },
                PeopleManager: function PeopleManager(targetInfo) {
                    return new index_2.PeopleManager(targetInfo);
                },
                PeoplePicker: function PeoplePicker(targetInfo) {
                    return new index_2.PeoplePicker(targetInfo);
                },
                ProfileLoader: function ProfileLoader(targetInfo) {
                    return new index_2.ProfileLoader(targetInfo);
                },
                RequestType: RequestType,
                Search: function Search(url, targetInfo) {
                    return new index_2.Search(url, targetInfo);
                },
                Site: function Site(url, targetInfo) {
                    return new index_2.Site(url, targetInfo);
                },
                SocialFeed: SocialFeed,
                SPTypes: SPTypes,
                Types: Types,
                UserProfile: function UserProfile(targetInfo) {
                    return new index_2.UserProfile(targetInfo);
                },
                Web: function Web(url, targetInfo) {
                    return new index_2.Web(url, targetInfo);
                }
            };
