        ...
        MethodInfo.prototype.generateParams = function () {
                ...
                for (var i = 0; i < this.methodInfo.argNames.length && i < this.methodInfo.argValues.length; i++) {
                    ...
                    switch (typeof (this.methodInfo.argValues[i])) {
                        ...
                        case "number":
                            ...
                            break;
                        case "string":
                            params[name_1] = this.replace ? value : "'" + value + "'";
                            break;
                        default:
                            params[name_1] = value;
                            break;
            ...
            if (this.methodParams) {
                ...
                if (this.methodInfo.data) {
                    ...
                    this.methodParams = JSON.parse(this.methodInfo.data.replace("{{data}}", JSON.stringify(this.methodParams)));
                }
...
(function ($REST) {
    ...
    var Fields = (function (_super) {
        ...
        function Fields(listName, settings, executeRequestFl) {
            ...
            // Default the properties
            this.defaultToWebFl = true;
            this.targetInfo.endpoint = "web/" + (listName ? "lists/" : "") + "fields";
            // See if we are executing the request
            if (this.executeRequestFl) {
                // Execute the request
                this.execute();
...
(function ($REST) {
    ...
    var File = (function (_super) {
        ...
        // Constructor
        /*********************************************************************************************************************************/
        function File(serverRelativeUrl, settings, executeRequestFl) {
            // Call the base constructor
            _super.call(this, settings, executeRequestFl);
            // Default the properties
            this.defaultToWebFl = true;
...
(function ($REST) {
    ...
    var Folder = (function (_super) {
        ...
        // Constructor
        /*********************************************************************************************************************************/
        function Folder(serverRelativeUrl, settings, executeRequestFl) {
            // Call the base constructor
            _super.call(this, settings, executeRequestFl);
            // Default the properties
            this.defaultToWebFl = true;
...
(function ($REST) {
    ...
    var Items = (function (_super) {
        ...
        // Constructor
        /*********************************************************************************************************************************/
        function Items(listName, settings, executeRequestFl) {
            // Call the base constructor
            _super.call(this, settings, executeRequestFl);
            // Default the properties
            this.defaultToWebFl = true;
...
(function ($REST) {
    ...
    var RoleAssignments = (function (_super) {
        ...
        // Constructor
        /*********************************************************************************************************************************/
        function RoleAssignments(settings, executeRequestFl) {
            // Call the base constructor
            _super.call(this, settings, executeRequestFl);
            // Default the properties
            this.defaultToWebFl = true;
...
(function ($REST) {
    ...
    var UserCustomActions = (function (_super) {
        ...
        // Constructor
        /*********************************************************************************************************************************/
        function UserCustomActions(settings, executeRequestFl) {
            // Call the base constructor
            _super.call(this, settings, executeRequestFl);
            // Default the properties
            this.defaultToWebFl = true;
