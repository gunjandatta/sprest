import { IBase, IBasePermissions, IContentTypeMethods, IContentTypes, IEventReceiverMethods, IEventReceivers, IFieldMethods, IFields, IFileMethods, IFolderMethods, IListMethods, IListItemMethods, IListItems, IResourcePath, IRoleAssignmentMethods, IRoleAssignments, IStringValue, ITargetInfo, IUserCustomActionMethods, IUserCustomActions, IViewMethods, IViews, IWebMethods, SPTypes } from "..";
/**
 * List
 */
