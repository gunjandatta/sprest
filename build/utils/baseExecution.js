 ...
 * Base Execution
 */
var BaseExecution = /** @class */ (function () {
    ...
    BaseExecution.prototype.executeMethod = function (methodName, methodConfig, args) {
        var targetInfo = null;
    ...
    // Method to execute the request
    BaseExecution.prototype.executeRequest = function (asyncFl, callback) {
        var _this = this;
    ...
    BaseExecution.prototype.getCollection = function (method, args) {
        // Copy the target information
    ...
    BaseExecution.prototype.getNextSetOfResults = function () {
    ...
    BaseExecution.prototype.getProperty = function (propertyName, requestType) {
        // Copy the target information
        var targetInfo = Object.create(this.targetInfo);
    ...
    BaseExecution.prototype.updateMetadataUri = function (metadata, targetInfo) {
    ...
    BaseExecution.prototype.updateDataObject = function (isBatchRequest) {
    ...
    BaseExecution.prototype.validateDataCollectionResults = function () {
        var _this = this;
        // Return a promise
