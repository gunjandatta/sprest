System.register(["../types/index", "./index"], function (exports_1, context_1) {
    ...
    var index_1, index_2, MethodInfo;
    return {
        setters: [
            function (index_1_1) {
                index_1 = index_1_1;
        ...
        execute: function () {
            ...
            MethodInfo = class MethodInfo {
                ...
                get requestMethod() {
                    ...
                    switch (this.methodInfo.requestType) {
                        case index_1.RequestType.Delete:
                        case index_1.RequestType.Post:
                        case index_1.RequestType.PostWithArgs:
                        case index_1.RequestType.PostWithArgsInBody:
                        case index_1.RequestType.PostWithArgsInQS:
                        case index_1.RequestType.PostWithArgsValueOnly:
                        case index_1.RequestType.PostReplace:
                            return "POST";
                        default:
                            return "GET";
                    }
                ...
                // Private Variables
                /*********************************************************************************************************************************/
                get passDataInBody() { return this.methodInfo.requestType == index_1.RequestType.GetWithArgsInBody || this.methodInfo.requestType == index_1.RequestType.PostWithArgsInBody; }
                get passDataInQS() { return this.methodInfo.requestType == index_1.RequestType.GetWithArgsInQS || this.methodInfo.requestType == index_1.RequestType.PostWithArgsInQS; }
                get isTemplate() { return this.methodInfo.data ? true : false; }
                get replace() { return this.methodInfo.requestType == index_1.RequestType.GetReplace || this.methodInfo.requestType == index_1.RequestType.PostReplace; }
                /*********************************************************************************************************************************/
                // Private Methods
                /*********************************************************************************************************************************/
                ...
                generateUrl() {
                    ...
                    if (this.methodInfo.requestType == index_1.RequestType.Delete) {
                        // Update the url
                        url = "deleteObject";
                    }
                    ...
                    else if (this.methodInfo.requestType == index_1.RequestType.OData) {
                        let oData = new index_2.OData(this.methodParams["oData"]);
                        // Update the url
                        ...
                        if (data) {
                            ...
                            for (let name in data) {
                                ...
                                switch (this.methodInfo.requestType) {
                                    ...
                                    case index_1.RequestType.GetWithArgsValueOnly:
                                    case index_1.RequestType.PostWithArgsValueOnly:
                                        params += value + ", ";
                                        break;
            ...
            exports_1("MethodInfo", MethodInfo);
        }
    };
});
