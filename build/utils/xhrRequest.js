System.register(["../lib/index", "./index"], function (exports_1, context_1) {
    ...
    var index_1, index_2, XHRRequest;
    return {
        setters: [
            function (index_1_1) {
                index_1 = index_1_1;
        ...
        execute: function () {
            ...
            XHRRequest = class XHRRequest {
                ...
                constructor(asyncFl, targetInfo, callback) {
                    ...
                    this.promise = new index_2.Promise(callback || targetInfo.callback);
                ...
                defaultHeaders() {
                    ...
                    if (this.targetInfo.requestDigest) {
                        ...
                        let requestDigest = index_1.ContextInfo.document.querySelector("#__REQUESTDIGEST");
