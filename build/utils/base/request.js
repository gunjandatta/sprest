...
var methodInfo_1 = require("../methodInfo");
...
var Request = /** @class */ (function (_super) {
    ...
    Request.prototype.executeMethod = function (methodName, methodConfig, args) {
        var targetInfo = null;
        ...
        var methodInfo = new methodInfo_1.MethodInfo(methodName, methodConfig, args);
        // Update the target information
        targetInfo.bufferFl = methodConfig.requestType == requestType_1.RequestType.GetBuffer;
        ...
        // Create a new object
        var obj = new base_1.Base(targetInfo);
        // Set the properties
    ...
    Request.prototype.executeRequest = function (asyncFl, callback) {
        var _this = this;
        var isBatchRequest = this.base && this.base.batchRequests && this.base.batchRequests.length > 0;
        var targetInfo = isBatchRequest ? batch_1.Batch.getTargetInfo(this.base.batchRequests) : new targetInfo_1.TargetInfo(this.targetInfo);
        ...
        if (asyncFl) {
            ...
            if (this.xhr && !isBatchRequest) {
                ...
                // Create the request
                this.xhr = new xhrRequest_1.XHRRequest(asyncFl, targetInfo, function () {
                    ...
                    if (_this.requestType == requestType_1.RequestType.GetBuffer) {
                        // Execute the callback
        ...
        // Else, we haven't executed this request
            ...
            // Create the request
            this.xhr = new xhrRequest_1.XHRRequest(asyncFl, targetInfo);
            // Update the response and status
    ...
    Request.prototype.getCollection = function (method, args) {
        // Copy the target information
    ...
    Request.prototype.getNextSetOfResults = function () {
    ...
    Request.prototype.getProperty = function (propertyName, requestType) {
        // Copy the target information
        var targetInfo = Object.create(this.targetInfo);
        // See if this is a graph request
        if (requestType.startsWith("graph")) {
            // Default the request type
            targetInfo.requestType = requestType_1.RequestType.GraphGet;
        }
        // Clear the target information properties from any previous requests
        targetInfo.data = null;
        targetInfo.method = null;
    ...
    Request.prototype.updateMetadataUri = function (metadata, targetInfo) {
    ...
    Request.prototype.validateDataCollectionResults = function () {
        var _this = this;
        // Return a promise
