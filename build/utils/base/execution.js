...
var Execution = /** @class */ (function (_super) {
    ...
    Execution.prototype.batch = function () {
        var args = [];
        ...
        if (appendFl && this.base.batchRequests) {
            ...
            this.base.batchRequests[this.base.batchRequests.length - 1].push({
                callback: callback,
                targetInfo: new targetInfo_1.TargetInfo(this.targetInfo)
            });
        }
        else {
    ...
    Execution.prototype.execute = function () {
        ...
        if (this.targetInfo.requestType == requestType_1.RequestType.OData) {
            // Return the parent
            return this.parent;
        }
        // Return this object
    ...
    Execution.prototype.executeAndWait = function () { return this.executeRequest(false); };
    // Method to wait for the parent requests to complete
    Execution.prototype.waitForRequestsToComplete = function (callback, requestIdx) {
        var _this = this;
