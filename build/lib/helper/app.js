        ...
        execute: function () {
            ...
            exports_1("AppHelper", AppHelper = {
                ...
                copyFileToHostWeb: (fileUrl, dstFolder, overwriteFl, rootWebFl) => {
                    ...
                    let origVal = index_2.ContextInfo.window.$REST.DefaultRequestToHostFl;
                    // Ensure the current web is an app web
                    if (!index_2.ContextInfo.isAppWeb) {
                        // Error
                        console.error("[gd-sprest] The current web is not an app web.");
                        return;
                    }
                    // Get the host web
                    index_2.ContextInfo.window.$REST.DefaultRequestToHostFl = true;
                    let web = (new index_2.Web(rootWebFl ? index_2.ContextInfo.siteServerRelativeUrl : null));
                    ...
                    if (typeof (dstFolder) === "string") {
                        ...
                        // Set the file urls
                        let dstFileUrl = index_2.ContextInfo.window.SP.Utilities.UrlBuilder.urlCombine(dstFolder.ServerRelativeUrl, fileName);
                        let srcFileUrl = index_2.ContextInfo.window.SP.Utilities.UrlBuilder.urlCombine(index_2.ContextInfo.webServerRelativeUrl, fileUrl.substr(fileUrl[0] == "/" ? 1 : 0));
                        ...
                        index_2.ContextInfo.window.$REST.DefaultRequestToHostFl = false;
                        // Get the current web
                        (new index_2.Web())
                ...
                getFolder: (web, folderUrl, createFl) => {
                    ...
                    web.done(() => {
                        ...
                        let dstFolderUrl = index_2.ContextInfo.window.SP.Utilities.UrlBuilder.urlCombine(web.ServerRelativeUrl, folderUrl.substr(folderUrl[0] == "/" ? 1 : 0));
                        // Get the folder
