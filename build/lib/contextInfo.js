System.register(["../utils/index"], function (exports_1, context_1) {
    ...
    var index_1, _ContextInfo, ContextInfo;
    return {
        setters: [
            function (index_1_1) {
                index_1 = index_1_1;
        ...
        execute: function () {
            ...
            /*********************************************************************************************************************************/
            _ContextInfo = class _ContextInfo {
            ...
            _ContextInfo.getWeb = (url) => {
                // Create a new base object
                return new index_1.Base({
                    endpoint: "contextinfo",
                    method: "POST",
                    url
                });
            };
            exports_1("ContextInfo", ContextInfo = _ContextInfo);
        }
    };
});
