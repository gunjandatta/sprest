...
export const Helper: IBaseHelper = {
    ...
    // Method to wait for all requests to complete, before resolving the request
        ...
        Helper.waitForRequestsToComplete(base, () => {
    ...
    execute: (base: IBase, args: Array<any>) => {
        ...
        if (waitFl) {
            ...
            Helper.waitForRequestsToComplete(base, () => {
                ...
                Helper.executeRequest(base, true, (response, errorFl) => {
            ...
            if (base.xhr && !isBatchRequest) {
                ...
                base.xhr = new XHRRequest(asyncFl, targetInfo, () => {
                    ...
                    if (base.requestType == RequestType.GetBuffer) {
                        ...
                        Helper.updateDataObject(base, isBatchRequest);
                        ...
                        if (!isBatchRequest) {
                            ...
                            if (base.xml) {
                                ...
                                Helper.validateDataCollectionResults(base).then(() => {
                                    // Execute the callback
                                    callback ? callback(base, errorFl) : null;
                                });
                            }
