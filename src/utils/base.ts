...
export class Base {
    ...
    // The base settings
    protected targetInfo:TargetInfoSettings;
    ...
    protected executeMethod(methodName:string, methodConfig:MethodInfoSettings, args?:any) {
        let targetInfo:TargetInfoSettings = null;
    ...
    private updateMetadataUri(metadata:any, targetInfo:TargetInfoSettings) {
        // See if this is a field
    ...
    private validateDataCollectionResults(request:Request, promise?:Promise) {
