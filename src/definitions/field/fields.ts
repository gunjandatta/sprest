...
export interface IFieldsMethods {
     ...
     */
    addDependentLookupField(displayName, primaryLookupField, showField): IBase<IFieldResult>;
     ...
     */
    createFieldAsXml(schemaXml): IBase<IFieldResult>;

    /**
     * Gets the field with the specified ID.
     * @param id - The field id.
     */
    getById(id): IBase<IFieldResult>;

    /**
     * Returns the first Field object with the specified internal name or title from the collection.
     * @param internalNameOrTitle - The internal name or title of the field.
     */
    getByInternalNameOrTitle(internalNameOrTitle): IBase<IFieldResult>;

    /**
     * Returns the first field object in the collection based on the title of the specified field.
     * @param title - The title of the field.
     */
    getByTitle(title): IBase<IFieldResult>;
