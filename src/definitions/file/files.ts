...
export interface IFilesMethods {
     ...
     */
    add(overwrite, url, content): IBase<IFileResult>;
     ...
     */
    addTemplateFile(urlOfFile, templateFileType: SPTypes.FileTemplateType): IBase<IFileResult>;

    /**
     * Get the file at the specified URL.
     * @param serverRelativeUrl - The name or server relative url of the file.
     */
    getByUrl(serverRelativeUrl): IBase<IFileResult>;
