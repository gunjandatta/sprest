...
module $REST {
    ...
    /*********************************************************************************************************************************/
    Library.list = {};
    Library.list[RequestType.Get] = ["getRelatedFields", "getView"];
    Library.list[RequestType.GetDataAsParameter] = ["getUserEffectivePermissions"];
    Library.list[RequestType.Post] = [
    ...
    Library.list[RequestType.PostDataInBodyNoArgs] = ["getChanges", "getItems", "getListItemChangesSinceToken"];
    Library.list[RequestType.Custom] = [
