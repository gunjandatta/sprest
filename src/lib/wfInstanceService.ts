import { IWorkflowInstanceService } from "../../@types/lib";
 ...
 */
export const WorkflowInstanceService: IWorkflowInstanceService = ((url: string, targetInfo?: ITargetInfoProps) => {
    ...
    return wfs;
}) as any as IWorkflowInstanceService;